...
con.connect(function(err) { 
  ...
  sql +="  `psw` varchar(30) NOT NULL,"
  sql +="  `fname` varchar(16) NOT NULL,"
  sql +="  `lname` varchar(16) NOT NULL,"
  sql +="  `mail` varchar(31) NOT NULL,"
  sql +="  `birthDate` varchar(15) NOT NULL,"
  sql +="  `study` varchar(30)"
  sql +="  `intrest1` int(11),"
  sql +="  `intrest2` int(11),"
  sql +="  `intrest3` int(11),"
  sql +="  `intrest4` int(11),"
